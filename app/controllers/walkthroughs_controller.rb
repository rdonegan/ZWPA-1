class WalkthroughsController < ApplicationController
  ...
  private
    ...
    def walkthrough_params
      params.require(:walkthrough).permit(:request_id, :square_footage, :num_floors, :max_occupancy, :other_businesses, 
        :other_businesses_type, :ownership, :waste_disposal_contract, :waste_management_cost, :loading_dock, 
        :freight_elevators, :storage_space, :storage_space_details, :trash_hauler, :trash_hauler_contract, 
        :contract_available, :annual_record, :waste_storage, 
        {:waste_containers => []}, :buy_recycled, :buy_recycled_details, :green_cleaning_products, 
        :green_cleaning_details, :mandated_recycling, :recycling_program, :recycling_details, 
        :recycling_stream, :recycling_stream_details, :discontinued_recycling, :current_compost, 
        :past_compost, :generate_toner_ink, :recycle_toner_ink, :generate_CFLs, :recycle_CFLs, 
        :generate_batteries, :recycle_batteries, :generate_computers, :recycle_computers, :generate_cellphones, 
        :recycle_cellphones, :generate_tvs, :recycle_tvs, :generate_other_corded_equipment, :recycle_cellphones, 
        :generate_furniture, :recycle_furniture, :generate_linens_uniforms, :recycle_linens_uniforms, 
        :generate_construction_debris, :recycle_construction_debris, :generate_pallets, :recycle_pallets, :ZW_policy, 
        :LEED, :recertify_LEED, :requesting_audit_services, :date)
    end
end
