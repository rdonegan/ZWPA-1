module Contexts
	module RequestContexts
		def create_requests
			@request1 = FactoryGirl.create(:request, contact_firstname: "John", contact_lastname: "Doe", 
				...
				zip_code: "15213")
			sleep 1
			@request2 = FactoryGirl.create(:request, contact_firstname: "Ernie", contact_lastname: "Wilson", 
				...
				zip_code: "15289")
			sleep 1
			@request3 = FactoryGirl.create(:request, contact_firstname: "Bill", contact_lastname: "Lee", 
