class RequestsController < ApplicationController
  ...
  private
    ...
    def request_params
      params.require(:request).permit(:customer_id, :contact_firstname, :contact_lastname, :title, :email, :phone, :street_address, :city, :zip_code, :state, :date, :Note, :request_id, :photo, :description)
    end
end
